...
extern int z_vrfy_counter_set_guard_period(const struct device * dev, uint32_t ticks, uint32_t flags);
		...
		uintptr_t arg3, uintptr_t arg4, uintptr_t arg5, void *ssf)
{
	...
	parm2.x = arg2;
	int ret = z_vrfy_counter_set_guard_period(parm0.val, parm1.val, parm2.val);
