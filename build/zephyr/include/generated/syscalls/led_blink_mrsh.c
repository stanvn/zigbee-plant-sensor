...
extern int z_vrfy_led_blink(const struct device * dev, uint32_t led, uint32_t delay_on, uint32_t delay_off);
		...
		uintptr_t arg3, uintptr_t arg4, uintptr_t arg5, void *ssf)
{
	...
	parm3.x = arg3;
	int ret = z_vrfy_led_blink(parm0.val, parm1.val, parm2.val, parm3.val);
